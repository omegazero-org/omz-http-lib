...
/**
 * A Huffman Coding implementation for <i>HPACK</i>.
 * 
 * @since 1.2.1
 */
public class HPackHuffmanCoding {
	 ...
	 * @return The decoded string data, or {@code null} if a decoding error occurred
	 * @see #encode(byte[])
	 */
				...
				if(bit == '0'){
					...
					if(i == bitsNum - 1){
						if(current.right != null)
							throw new RuntimeException("Could not add node for value " + number + " to tree because right node is not a leaf node");
